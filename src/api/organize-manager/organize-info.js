...
// 获取部门树,管理员获取全部
export const getauthlisttreeReq = data => {
  return requestCenter({
    url: '/api/usercenter/v1/organzie/getauthlisttree',
    method: 'post',
    data
  })
}
...
//下拉分页查询
export const organizePageListUrl =()=> `${window.localStorage.getItem("configip")}/api/usercenter/v1/organzie/getpagelist`
