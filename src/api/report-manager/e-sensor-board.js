...
export const geteqparameterListReq = data => {
  return requestCenter({
    url: '/api/reportcenter/anonymous/v1/furnacemonitoring/getesensorhistory',
    method: 'post',
    data
  })
}
...
// 获取温区温度
export const getTempReq = data => {
  return requestCenter({
    url: '/api/reportcenter/anonymous/v1/furnacemonitoring/getesensordynamic',
    method: 'post',
    data
  })
}
...
// 获取温区下拉选列表
export const getFurnaceEquipmentReq = data => {
  return requestCenter({
