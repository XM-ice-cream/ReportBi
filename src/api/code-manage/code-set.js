...
// 分页查询
export const codePageListUrl =()=> `${window.localStorage.getItem("configip")}/api/systemcenter/v1/coderulecollection/getpagelist`
...
export const getlogpagelistReq = data => {
  return requestCenter({
    url: '/api/systemcenter/v1/coderulerelationlog/getpagelist',
    method: 'post',
    data
  })
}
