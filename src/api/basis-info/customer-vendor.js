...
//分页查询
export const customPageListUrl =()=> `${window.localStorage.getItem("configip")}/api/systemcenter/v1/customervendor/getpagelist`

// 查询单个信息
export const getentityReq = data => {
  return requestCenter({
    url: '/api/systemcenter/v1/customervendor/getentity',
    method: 'post',
    data
  })
}
