...
export default {
  ...
  controlList: [
    ...
    { title: 'stove-tm', to: 'stove-tm' },
    { title: 'stove-tm-spc', to: 'stove-tm-spc' },
    { title: 'stove-tm-rhi', to: 'stove-tm-rhi' },
    { title: 'e-sensor-board', to: 'e-sensor-board' },
    { title: 'quality-check-material', to: 'quality-check-material' },
  ],
  // reflow报表菜单
  reflowList: [
    { title: 'stove-tm', to: 'stove-tm' },
