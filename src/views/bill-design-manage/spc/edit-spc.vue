<template>
  <div>
    <Modal :title="isAdd?'新增':'编辑'" :mask-closable="false" :closable="true" v-model="dialogFormVisible" fullscreen :before-close="closeDialog">
