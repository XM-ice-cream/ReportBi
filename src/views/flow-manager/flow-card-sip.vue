...
export default {
	...
	data() {
		return {
			...
			columns: [
				...
				{ title: "工单", key: "workorder", align: "center", width: 120, tooltip: true, resizable: true },
				{ title: "CONFIG", key: "woconfig", align: "center", width: 150, tooltip: true, resizable: true },
				{ title: "大板码", key: "panelid", align: "center", width: 140, tooltip: true, resizable: true },
				{ title: "小板码", key: "unitid", align: "center", width: 140, tooltip: true, resizable: true },
				{ title: "途程", key: "planid", align: "center", width: 150, tooltip: true, resizable: true },
				{ title: "料号", key: "productid", align: "center", width: 140, tooltip: true, resizable: true },
				{ title: "状态", key: "state", align: "center", width: 80, tooltip: true, resizable: true },
				{ title: "线体", key: "line", align: "center", width: 100, tooltip: true, resizable: true },
				{ title: "站点", key: "stepid", align: "center", width: 150, tooltip: true, resizable: true },
				{ title: "设备ID", key: "eqpid", align: "center", width: 150, tooltip: true, resizable: true },
				{ title: "进站时间", key: "trackintime", align: "center", width: 150, tooltip: true, resizable: true },
				{ title: "出站时间", key: "trackouttime", align: "center", width: 150, tooltip: true, resizable: true },
	...
	methods: {
		...
		pageLoad() {
			...
			let { startTime, endTime, unitId, lineName, pn, wo, panelNo, unitId56, buildConfig, curprocessname, cartonno, currentstatus, isHistory } =
				this.req;
			if (
				(startTime && endTime) ||
				unitId ||
