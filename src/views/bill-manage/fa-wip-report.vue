                    ...
                    <div class="poptip-style-content" slot="content">
                      <Form ref="searchReq" :model="req" :label-width="80" :label-colon="true">
                        ...
                        <FormItem :label="$t('workOrder')" prop="workOrder">
                          <v-selectpage v-if="poptipModal" ref="workOrder" class="select-page-style" multiple key-field="workOrder" show-field="workOrder" :data="workerPageListUrl" v-model="req.workOrder" :placeholder="$t('pleaseSelect') + $t('workOrder')" :result-format="
                          (res) => {
                            return {
                              totalRow: res.total,
                              list: res.data || [],
                        ...
                        <FormItem :label="$t('process')" prop="stepName">
                          <v-selectpage class="select-page-style" ref="stepName" multiple v-if="poptipModal" key-field="name" show-field="name" :data="processPageListUrl" v-model="req.stepName" :placeholder="$t('pleaseSelect') + $t('process')" :result-format="
                        (res) => {
                        return {
                            totalRow: res.total,
                            list: res.data || [],
