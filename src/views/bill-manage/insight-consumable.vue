...
<script>
import { getpagelistReq ,attendanceInsightUploadUrl } from "@/api/bill-manage/insight-consumable.js";
import {  getButtonBoolean,formatDate, renderDate } from "@/libs/tools";
import AddModify from "./insight-consumable/add-modify.vue";
import UploadCustom from "@/components/upload-custom";


export default {
  name: "insight-consumable",
  ...
  methods: {
    ...
    pageLoad () {
        this.data = [];
        this.tableConfig.loading = false;
        const { startTime, endTime,modelName,customerModelName,stepName,uploadStepName} = this.req;
        this.$refs.searchReq.validate((validate) => {
            ...
            let obj = {
                ...
                data: {
                    ...
                    modelName,customerModelName,stepName,uploadStepName
                },
            };
