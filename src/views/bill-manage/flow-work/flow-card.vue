...
import JumpStation from "./jump-station.vue";
  ...
  data() {
    return {
      ...
      columns: [
        ...
        {title: this.$t("workOrder"), key: "workOrder", fixed: "left", width: 120, tooltip: true},
        {title: this.$t("bigBarcode"), key: "panelNo", fixed: "left", width: 140},
        {
          title: this.$t("sn"),
          key: "unitId",
          fixed: "left",
        ...
        {title: this.$t("nextProcessName"), key: "nextProcessName", width: 200, tooltip: true},
        {title: this.$t("partName"), key: "partName", width: 150},
        {title: this.$t("lineName"), key: "lineName", width: 120},
        {title: this.$t("equipmentId"), key: "eqpId", width: 150, tooltip: true},
        {title: this.$t("flow"), key: "routeName", width: 110},
        {title: this.$t("unitId56"), key: "unitId56", width: 200, tooltip: true},
        {title: this.$t("inProcessTime"), key: "inProcessTime", width: 125, render: renderDate},
        {title: this.$t("outProcessTime"), key: "outProcessTime", width: 125, render: renderDate},
        {title: this.$t("palletCode"), key: "palletNo", width: 100},
        {title: this.$t("cartonCode"), key: "cartonNo", width: 100},
        {title: this.$t("boxCode"), key: "boxNo", width: 100},
        {title: this.$t("action"), key: "action", width: 80},
        {title: "carrier", key: "carrier", width: 180},
        {title: "magazine", key: "magazine", width: 180},
        {title: this.$t("remark"), key: "remark", width: 180},
        {title: this.$t("createUserName"), key: "createUserName", width: 125},
        {title: this.$t("operationDate"), key: "createDate", render: renderDate, width: 125},
      ], // 表格数据
      req: {
        inProcessTime: "", // 进制程时间
