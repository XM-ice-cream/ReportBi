  ...
  <div class="page-style">
    ...
    <div class="comment">
      <Card :bordered="false" dis-hover class="card-style">
        ...
        <Table :border="tableConfig.border" :highlight-row="tableConfig.highlightRow" :height="tableConfig.height" :loading="tableConfig.loading" :columns="columns" :data="data" :row-class-name="tableRowClassName"></Table>
