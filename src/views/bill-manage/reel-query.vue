...
import { renderIsEnabled, renderDate, getButtonBoolean, formatDate, exportFile } from "@/libs/tools";
				...
				{ title: this.$t("pn"), key: "pn", width: 140, tooltip: true, align: "center" },
				{
					...
					render: (h, params) => {
						...
						if (this.reelQueryTypeList.length) {
							let valItem = this.reelQueryTypeList.find((o) => o.detailCode === params.row.category) || {};
