	...
	<div class="page-style">
		...
		<Drawer v-model="drawerFlag" :title="drawerTitle" width="500" :mask-closable="false" @on-close="cancelClick">
			<Form ref="submitReq" :model="submitData" :rules="ruleValidate" :label-width="90" @submit.native.prevent>
				...
				<!-- EQPID -->
				<FormItem label="EQPID" prop="eqpid">
					<Input v-model="submitData.eqpid" :placeholder="$t('pleaseEnter') + 'EQPID'" />
				</FormItem>
				<!-- 备注 -->
	...
	data() {
		return {
			...
			columns: [
				...
				{ title: "项目", key: "item", align: "center", minWidth: 80, tooltip: true },
				{ title: "站点", key: "station", align: "center", minWidth: 120, tooltip: true },
				...
				{ title: "USL", key: "usl", align: "center", minWidth: 80, tooltip: true },
				{ title: "LSL", key: "lsl", align: "center", minWidth: 80, tooltip: true },
				{ title: "UCL", key: "ucl", align: "center", minWidth: 80, tooltip: true },
				{ title: "LCL", key: "lcl", align: "center", minWidth: 80, tooltip: true },
