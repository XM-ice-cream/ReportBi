  ...
  <div class="page-style">
    ...
    <div class="comment">
      <Card :bordered="false" dis-hover class="card-style">
        ...
        <Table :row-class-name="tableRowClassName" :border="tableConfig.border" :highlight-row="tableConfig.highlightRow" :height="tableConfig.height" :loading="tableConfig.loading" :columns="columns" :data="data" @on-current-change="currentClick" @on-sort-change="sortChange"></Table>
      ...
      <Form ref="submitReq" :model="submitData" :rules="ruleValidate" :label-width="110" :label-colon="true" @submit.native.prevent>
        ...
        <Table :border="true" :max-height="250" :columns="insightColumns" :data="insightData" style="margin-bottom: 16px">
          <template slot-scope="{ row,index }" slot="action">
            <Button type="error" size="small" @click="insightData.splice(index,1)" icon="iconfont icon-delete">
            </Button>
          </template>
        </Table>
        <!-- 按钮 -->
