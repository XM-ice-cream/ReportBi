  ...
  data () {
    return {
      ...
      columns: [
        ...
        { title: "Radar No.", key: "radarno", align: "center", minWidth: 120, tooltip: true, inputType: "input" },
        ...
        { title: "Issue Description", key: "issuedescription", align: "center", minWidth: 140, tooltip: true, inputType: "input" },
        ...
        { title: "Shipment Date", key: "shipmentdate", align: "center", minWidth: 120, tooltip: true, render: renderDate, inputType: "datetime" },
        ...
        { title: "Report time", key: "reportdate", align: "center", minWidth: 120, tooltip: true, render: renderDate, inputType: "datetime" },
