									...
									<Form ref="searchReq" :model="req" :label-width="80" :label-colon="true" @submit.native.prevent @keyup.native.enter="searchClick">
										...
										<FormItem :label="$t('workOrder')" prop="workOrder">
											<Input
												...
												:placeholder="$t('pleaseEnter') + $t('workOrder') + '多个以英文逗号或空格分隔'"
												@on-search="pageLoad"
											/>
										</FormItem>
										<!-- 产品序号 -->
										<FormItem :label="$t('product') + $t('sort')" prop="unitId">
											<Input
												v-model="req.unitId"
												:placeholder="$t('pleaseEnter') + $t('product') + $t('sort') + '多个以英文逗号或空格分隔'"
												@on-search="pageLoad"
											/>
										</FormItem>
										<!-- 栈板号 -->
										<FormItem :label="$t('palletCode')" prop="palletNo">
											<Input
												v-model="req.palletNo"
												:placeholder="$t('pleaseEnter') + $t('palletCode') + '多个以英文逗号或空格分隔'"
												@on-search="pageLoad"
											/>
										</FormItem>
										<!-- BoxNo -->
