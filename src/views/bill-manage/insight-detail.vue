...
<script>
import { getpagelistReq ,addReq,modifyReq ,attendanceInsightUploadUrl } from "@/api/bill-manage/insight-detail";
  ...
  data () {
    return {
      ...
      columns: [
        ...
        { title: "品名", key: "origin", align: "center", minWidth: 140, tooltip: true },
        { title: "路由", key: "modelName", align: "center", minWidth: 140, tooltip: true },
