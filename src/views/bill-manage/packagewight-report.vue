                ...
                <div class="poptip-style-content" slot="content">
                  <Form ref="searchReq" :model="req" :label-width="80" :label-colon="true" @submit.native.prevent @keyup.native.enter="searchClick">
                    ...
                    <FormItem :label="$t('product') + $t('sort')" prop="unitId">
                      <Input v-model="req.unitId" :placeholder="$t('pleaseEnter') + $t('product') + $t('sort')+ $t('multiple,separated')" @on-search="pageLoad" />
                    </FormItem>
                    <!-- 大板码 -->
                    <FormItem :label="$t('panelNo')" prop="panelNo">
                      <Input v-model="req.panelNo" :placeholder="$t('pleaseEnter') + $t('panelNo')+ $t('multiple,separated')" @on-search="pageLoad" />
                    </FormItem>
                    <!-- BoxNo -->
