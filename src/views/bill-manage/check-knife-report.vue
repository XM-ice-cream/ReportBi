                  ...
                  <Form ref="searchReq" :model="req" :label-width="80" :label-colon="true"
                    ...
                    <FormItem :label="$t('startTime')" prop="startTime">
                      <DatePicker transfer type="datetime" :placeholder="$t('pleaseSelect') + $t('startTime')"
                                  ...
                                  v-model="req.startTime" style="width: 200px"></DatePicker>
                    </FormItem>
                    <!-- 结束时间 -->
                    <FormItem :label="$t('endTime')" prop="endTime">
                      <DatePicker transfer type="datetime" :placeholder="$t('pleaseSelect') + $t('endTime')"
                                  format="yyyy-MM-dd HH:mm:ss" :options="$config.datetimeOptions" v-model="req.endTime"
                    ...
                    <FormItem :label="$t('barCoding')" prop="code">
                      <Input v-model="req.code" :placeholder="$t('pleaseEnter') + $t('barCoding')"
                             @on-search="pageLoad"/>
                    </FormItem>
                    <!-- 验刀类别 -->
